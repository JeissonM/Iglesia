...
<div class="row clearfix">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h2>
                    {{$chat->contacto->feligres->personanatural->primer_nombre." ".$chat->contacto->feligres->personanatural->primer_apellido}}<small>Haga clic en el botón de 3 puntos de la derecha de este título para agregar un nuevo registro.</small>
                </h2>
