...
<ol class="breadcrumb breadcrumb-bg-blue-grey" style="margin-bottom: 30px;">
    ...
    <li class="active"><a>Editar Recurso</a></li>
</ol>
@endsection
@section('content')
                ...
                <div class="row clearfix">
                    <div class="col-md-12">
                        <table class="table table-hover">
                            <tbody>
                                <tr class="read">
                                    <td class="contact"><b>RECURSO</b></td>
                                ...
                                <tr class="read">
                                    <td class="contact">{{$r->ministerio->nombre}}</td>
                    ...
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal" role='form' method="POST" action="{{route('recursosministeriales.store2')}}" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="recursosministerial_id" value="{{$r->id}}" />
                            <div class='col-md-4'>
                    ...
                    <div class="col-md-12">
                        <h3 class="card-inside-title">LISTA DE ARCHIVOS EN EL RECURSO</h3>
                        <div class="table-responsive">
                            <table id="tabla" class="table table-bordered table-striped table-hover table-responsive table-condensed dataTable js-exportable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    @foreach($r->recursosministerialitems as $l)
                                    <tr>
                                        <td><a href="{{asset('docs/recursos/'.$l->recurso)}}" target="_blank">{{$l->recurso}}</a></td>
                                        <td>
                                            <a href="{{ route('recursosministeriales.delete2',[$r->id,$l->id])}}" class="btn bg-red waves-effect btn-xs" data-toggle="tooltip" data-placement="top" title="Eliminar Archivo"><i class="material-icons">delete</i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @endif
