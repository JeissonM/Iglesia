            ...
            <div class="body">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-md-2" style="margin-top: 15%;">
                        ...
                        <div class="col-md-12">
                            <center><button type="button" class="btn bg-red waves-effect" onclick="retirar()"> Quitar </button></center>
                        </div>
                        <div class="col-md-12">
                            <center><button type="button" class="btn bg-green waves-effect" onclick="agregarTodas()"> Agregar Todo </button></center>
                        </div>
                        <div class="col-md-12">
                            <center><button type="button" class="btn bg-red waves-effect" onclick="retirarTodas()"> Quitar Todo </button></center>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="col-md-12">
