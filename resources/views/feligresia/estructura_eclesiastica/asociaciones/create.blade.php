...
<div class="row clearfix">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h2>
                    GESTIÓN DE LAS ASOCIACIONES - CREAR UNA NUEVA ASOCIACIÓN
                </h2>
            </div>
            <div class="body">
                ...
                <div class="row clearfix">
                    <div class="col-md-12">
                        {!! Form::open(['route'=>'asociacion.store','method'=>'POST','class'=>'form-horizontal'])!!}
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="col-md-6">
                                    <div class="form-line">
                                        <label class="control-label">Nombre de la Asociación</label>
                                        {!! Form::text('nombre',null,['class'=>'form-control','placeholder'=>'Nombre oficial de la asociación','required']) !!}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-line">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-line">
                                        ...
                                        {!! Form::text('ubicacion',null,['class'=>'form-control','placeholder'=>'Dirección de ubicación de la asociación']) !!}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-6">
                                    <div class="form-line">
                                        ...
                                        {!! Form::email('email',null,['class'=>'form-control','placeholder'=>'Dirección de correo de la asociación']) !!}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-line">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <div class="form-line">
                                        ...
                                        {!! Form::select('union_id',$uniones,null,['class'=>'form-control chosen-select','placeholder'=>'-- Seleccione una opción --']) !!}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
