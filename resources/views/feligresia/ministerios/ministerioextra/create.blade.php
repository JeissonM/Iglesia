    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <div class="row clearfix">
                    <div class="col-md-12">
                        {!! Form::open(['route'=>'ministerio.store','method'=>'POST','class'=>'form-horizontal'])!!}
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="form-line">
                                    <br/>{!! Form::text('nombre',null,['class'=>'form-control','placeholder'=>'Escriba el nombre del ministerio','required']) !!}
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-line">
                                    <br/>{!! Form::text('descripcion',null,['class'=>'form-control','placeholder'=>'Descripción del ministerio (Opcional)']) !!}
                                </div>
                            </div>
                            <div class="form-group">
