...
<div class="row clearfix">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h2>
                    GESTIÓN DE MINISTERIOS EXTRA-OFICIALES - EDITAR MINISTERIO
                </h2>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <br/><select class="form-control show-tick select2" name="tipoministerio_id" required="">
                                            ...
                                            @if($ministerio->tipoministerio_id==$key)
