    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <h1 class="card-inside-title">EDITAR DATOS DEL ESTADO: {{$estado->descripcion}}</h1>
                <div class="row clearfix">
                    <div class="col-md-12">
                        <form class="form-horizontal" role='form' method="POST" action="{{route('estadocivil.update',$estado->id)}}">
                            @csrf 
                            <input name="_method" type="hidden" value="PUT" /> 
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <br/><input class="form-control" type="text" placeholder="Nombre del estado" name="descripcion" value="{{$estado->descripcion}}">    
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-col-orange">
            ...
            <div class="modal-body">
                <strong>Edite el estado civil,</strong>Administre los diferentes estados civil.
            </div>
