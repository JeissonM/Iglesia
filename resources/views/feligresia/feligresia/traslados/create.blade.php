...
<ol class="breadcrumb breadcrumb-bg-blue-grey" style="margin-bottom: 30px;">
    ...
    <li class="active"><a>Crear Tipo de Documento</a></li>
</ol>
@endsection
@section('content')
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <h1 class="card-inside-title">DATOS DEL TIPO</h1>
                <div class="row clearfix">
                    <div class="col-md-12">
                        <form class="form-horizontal" role='form' method="POST" action="{{route('tipodoc.store')}}">
                            @csrf 
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <br/><input class="form-control" type="text" placeholder="Escriba la abreviatura del tipo" required="required" name="abreviatura">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-line">
                                        <br/><input class="form-control" type="text" placeholder="Descripción del tipo" name="descripcion">    
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
